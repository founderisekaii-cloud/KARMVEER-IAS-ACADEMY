    ...
    <MainLayout>
      <div className="container py-12 md:py-20">
        ...
        <div className="max-w-3xl mx-auto mt-6 space-y-4 text-muted-foreground">
            <p>Karmveer IAS Institute is a premier coaching institute dedicated to preparing aspirants for various competitive government examinations like UPSC, MPSC, SSC, Banking, and more.</p>
